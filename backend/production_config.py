...
Production secrets and endpoints must be supplied by the deployment platform.
"""
...
def validate_production_config(env: dict[str, str] | None = None) -> ProductionConfig:
    ...
    return ProductionConfig(
        ...
        idp_url=idp_url,
        idp_client_id=values["NEON_IDP_CLIENT_ID"],
        idp_client_secret=values["NEON_IDP_CLIENT_SECRET"],
        session_secret=values["NEON_SESSION_SECRET"],
