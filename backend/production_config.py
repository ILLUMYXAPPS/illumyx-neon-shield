...
_REQUIRED = ("NEON_AUTH_DB", "NEON_IDP_URL", "NEON_IDP_CLIENT_ID", "NEON_IDP_CLIENT_SECRET", "NEON_SESSION_SECRET", "NEON_MONITORING_ENDPOINT")
...
def validate_production_config(env: dict[str, str] | None = None) -> ProductionConfig:
    ...
    return ProductionConfig(database_url, idp_url, values["NEON_IDP_CLIENT_ID"], values["NEON_IDP_CLIENT_SECRET"], values["NEON_SESSION_SECRET"], monitoring_endpoint)
